...
DAN.profile['dm_name'] = 'test' #新建iottalk裝置名稱
DAN.profile['df_list'] = ['test']    #新建iottalk裝置Device_Feature名稱
DAN.profile['d_name'] = 'test_device'  #這個裝置的名稱
...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("device2/temperature&Humidity") #MQTT的Topic訂閱
...
def on_message(client, userdata, msg):
    ...
    print("iottalk",det_Temperature,det_Humidity)
